 ...
 * @author Admin
 */
public class ReadConditions implements Tasklet, StepExecutionListener {

    private final ApplicationValues applicationValues;

    public ReadConditions(ApplicationValues applicationValues) {
    ...
    public RepeatStatus execute(StepContribution sc, ChunkContext cc) throws Exception {
        ...
        try {
            ...
            Integer persons;
            try {
                persons = Integer.parseInt(props.getProperty("persons"));
                //log.info("Va a generar {} personas", persons);
